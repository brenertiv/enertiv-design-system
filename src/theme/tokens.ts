 ...
 *
 * Copied from production (user-supplied 2026-09-09). enertiv-web clone
 * pending Bitbucket auth — replace this file from the frontend and update
 * docs/FRONTEND_SHA.md.
 *
...
export type SemanticPalette = typeof SEMANTIC_LIGHT;
